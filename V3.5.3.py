...
class Application:
    ...
    def __init__(self, root):
        ...
        # Остальная инициализация после успешного подключения (в init_ui)
        return
    ...
    def init_ui(self):
        ...
        self.stats_line1 = tk.Label(self.stats_frame, text="Количество изделий: 0", font=font1, anchor='w')
        self.stats_line2 = tk.Label(self.stats_frame, text="Суммарный периметр: 0.000 м", font=font1, anchor='w')
        self.stats_line3 = tk.Label(self.stats_frame, text="Суммарная площадь: 0.000 м²", font=font1, anchor='w')
